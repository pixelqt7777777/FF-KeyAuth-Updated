...
public static class SocketMemory
{
    ...
    private static readonly ConcurrentDictionary<ulong, BlockContainer> _cache = new ConcurrentDictionary<ulong, BlockContainer>();
    private static readonly ConcurrentDictionary<ulong, byte> _activeBlocks = new ConcurrentDictionary<ulong, byte>();
